						...
						<div class="col-sm-12">
							...
							<div class="card">
								...
								<div class="card-block">
									...
									<form action="<?php echo base_url('vendor/create'); ?>" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group row">
											...
											<div class="col-sm-10">
												<input type="text" name="kode_pelanggan" id="kode_pelanggan" required class="form-control form-control-round"
													placeholder="Kode Pelanggan" value="<?php echo no_urut_otomatis("vendor", "KodeVendor"); ?>">
											</div>
										</div>
