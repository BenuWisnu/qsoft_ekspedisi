						...
						<div class="col-sm-12">
							...
							<div class="card">
								...
								<div class="card-header">
									...
									<h5>Tambah Data Retur Kiriman</h5> 
								...
								<div class="card-block">
									...
									<form action="<?php echo base_url('returkiriman/create'); ?>" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group row">
											<label class="col-sm-2 col-form-label">No. Return</label>
											<div class="col-sm-10">
												<input type="text" name="akun_bayar" id="akun_bayar" required class="form-control form-control-round"
													placeholder="Akun Bayar" onkeyup="get_cabang()">
											</div>
										</div>
										...
										<div class="form-group row">
											<label class="col-sm-2 col-form-label">Tgl. Order</label>
											<div class="col-sm-10">
												<input type="date" name="tanggal_order" required class="form-control form-control-round"
