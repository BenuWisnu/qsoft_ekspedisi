						...
						<div class="col-sm-12">
							...
							<div class="card">
								...
								<div class="card-block">
									...
									<form action="<?php echo base_url('vendorekspedisi/create'); ?>" method="post" enctype="multipart/form-data">

						
                                        <div class="form-group row">
											<label class="col-sm-2 col-form-label">Kode Vendor</label>
											<div class="col-sm-10">
												<input type="text" name="kode_vendor" id="kode_vendor" required class="form-control form-control-round"
													placeholder="Kode Vendor" value="<?php echo no_urut_otomatis("vendor", "KodeVendor"); ?>">
											</div>
										</div>
										...
										<div class="form-group row">
											...
											<div class="col-sm-10">
												<input type="text" name="jenis_barang" required class="form-control form-control-round"
										...
										<div class="j-footer">
											...
											<a href="<?= base_url('vendorekspedisi'); ?>" class="btn btn-danger btn-round"><i class="feather icon-x"></i>Batalkan</a>
										</div>
