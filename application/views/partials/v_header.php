...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" href="<?= base_url(); ?>assets\images\details_open.png" type="image/x-icon">
    <!-- Google font-->
    ...
    <!-- Animate.css -->
    <link rel="stylesheet" type="text/css" href="<?= base_url(); ?>bower_components\animate.css\css\animate.css">
    <!-- Style.css -->
