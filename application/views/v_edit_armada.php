						...
						<div class="col-sm-12">
							...
							<div class="card">
								...
								<div class="card-block">
									...
									<form action="<?php echo base_url('armada/update/'.$data['NoKendaraan']); ?>" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group row">
											...
											<div class="col-sm-10">
                                                ...
                                                readonly
													placeholder="No. Kendaraan" value="<?= $data['NoKendaraan']; ?>">
											</div>
										</div>
										...
										<div class="form-group row">
											...
											<div class="col-sm-10">
												<input type="text" name="merek" required class="form-control form-control-round"
													placeholder="merek" value="<?= $data['Merek']; ?>">
											</div>
										</div>
										...
										<div class="form-group row">
											...
											<div class="col-sm-10">
												<input type="number" name="tahun_pembuatan" required class="form-control form-control-round"
													placeholder="Tahun Pembuatan" value="<?= $data['TahunPembuatan']; ?>">
											</div>
										</div>
										...
										<div class="form-group row">
											...
											<div class="col-sm-10">
												<input type="date" name="tanggal_pembelian" required class="form-control form-control-round"
													placeholder="" value="<?= $data['TanggalPembelian']; ?>">
											</div>
										</div>
										...
										<div class="form-group row">
											...
											<div class="col-sm-10">
												<input type="text" name="hp_sopir" id="hp_sopir" required class="form-control form-control-round"
													placeholder="Hp Sopir" value="<?= $data['HpSopir']; ?>">
											</div>
										</div>
