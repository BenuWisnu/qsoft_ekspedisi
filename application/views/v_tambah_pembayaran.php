						...
						<div class="col-sm-12">
							...
							<div class="card">
								...
								<div class="card-block">
									...
									<form action="<?php echo base_url('pembayaran/create'); ?>" method="post" enctype="multipart/form-data">
										...
										<div class="form-group row">
											<label class="col-sm-2 col-form-label">Akun Bayar</label>
											<div class="col-sm-10">
												<input type="text" name="akun_bayar" required class="form-control form-control-round"
													placeholder="Akun Bayar">
											</div>
										</div>
										...
										<div class="form-group row">
											...
											<div class="col-sm-10">
												<input type="text" name="no_invoice" required class="form-control form-control-round"
										...
										<div class="form-group row">
											<label class="col-sm-2 col-form-label">No. Bayar</label>
											<div class="col-sm-10">
												<input type="text" name="no_bayar" required class="form-control form-control-round"
													placeholder="No. Bayar">
											</div>
										</div>
