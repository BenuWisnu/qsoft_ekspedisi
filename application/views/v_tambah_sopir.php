						...
						<div class="col-sm-12">
							...
							<div class="card">
								...
								<div class="card-block">
									...
									<form action="<?php echo base_url('sopir/create'); ?>" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group row">
											...
											<div class="col-sm-10">
												<input type="text" name="kode_sopir" id="kode_sopir" required class="form-control form-control-round"
													placeholder="Kode Sopir" value="<?php echo no_urut_otomatis("sopir", "KodeSopir"); ?>">
											</div>
										</div>
