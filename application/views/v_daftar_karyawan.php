						...
						<div class="col-sm-12">
							<div class="card">
								<div class="card-block bg-gray">
									...
									<a href="<?= base_url('karyawan/add'); ?>" class="btn btn-success btn-round text-right"><i class="feather icon-plus"></i> Tambah Karyawan</a>
								</div>
							</div>
											...
											<tbody>
												...
												<tr>
													...
													<td>
															...
															href="<?= base_url('karyawan/edit/'.$data->KodeKaryawan); ?>"><i class="feather icon-edit-2"></i> Edit</a>
														<button class="btn btn-danger btn-round text-white f-12" onclick="ConfirmDialog(<?= $data->KodeKaryawan; ?>)">
...
<script type="text/javascript">
    ...
    function ConfirmDialog(id) {
		...
		if (x) {
          	window.location = url + "karyawan/delete/" + id;
		} else {
			return false;
		}
	}
  ...
  $('#dtHorizontalExample').DataTable({
    ...
    buttons: [
            ...
            },
            {
                ...
                return 'Daftar_Karyawan'+' <?= urldecode(""); ?>' + '_' + today;
              },
