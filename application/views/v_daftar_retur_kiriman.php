						...
						<div class="col-sm-12">
							<div class="card">
								<div class="card-block bg-gray">
									...
									<a href="<?= base_url('returkiriman/add'); ?>" class="btn btn-success btn-round text-right"><i class="feather icon-plus"></i> Tambah Retur Kiriman</a>
								</div>
							</div>
											...
											<tbody>
												...
												<tr>
													...
													<td>
															...
															href="<?= base_url('returkiriman/edit/'.$data->NoReturn); ?>"><i class="feather icon-edit-2"></i> Edit</a>
														<button class="btn btn-danger btn-round text-white f-12" onclick="ConfirmDialog(<?= $data->NoReturn; ?>)">
  ...
  $('#dtHorizontalExample').DataTable({
    ...
    buttons: [
            ...
            },
            {
                ...
                return 'Daftar_Retur_Kiriman'+' <?= urldecode(""); ?>' + '_' + today;
              },
